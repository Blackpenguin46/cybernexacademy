...
export default function YouTubePage() {
  ...
  // Filter logic with improved case insensitivity and null/undefined checking
  const filteredChannels = popularChannels.filter(channel => {
    // If no category is selected or it's "All", include all channels
    if (!selectedCategory || selectedCategory === 'All') {
      return true;
    }
    
    // Safety check for channel categories
