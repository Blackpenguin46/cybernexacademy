...
export default function DiscordPage() {
  ...
  const filteredServers = selectedCategory === 'All'
    ? discordServers
    : discordServers.filter(server => {
        // Safety check for server.categories
        ...
        return server.categories.some(category => 
          typeof category === 'string' && category.toLowerCase() === selectedCategoryLower
        );
      });
  ...
  return (
    <div className="min-h-screen bg-gray-950 pb-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-xl text-gray-400 max-w-2xl">
              Join our official CyberNex Academy Discord server and connect with other cybersecurity enthusiasts. We also recommend these other cybersecurity Discord servers to enhance your learning journey.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Community Benefits Section - Renamed from Why Join */}
      <section className="py-16 bg-gray-900/50">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-center mb-10">
              <ThumbsUp className="w-6 h-6 text-blue-500 mr-3" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className="bg-gray-900 border border-gray-800 rounded-lg p-5 hover:border-blue-500/30 transition-colors"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {guidelines.map((guideline, index) => (
                  <div key={index} className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 mt-0.5 mr-3">
      ...
      {/* Instagram Account Section - New Addition */}
      <section className="py-16 bg-gradient-to-b from-purple-900/20 to-purple-900/5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto mb-8">
              Stay updated with the latest cybersecurity tips, news, and community highlights by following our Instagram account.
            </p>
            
            <a 
              href="https://www.instagram.com/cybernex_academy" 
              target="_blank" 
              rel="noopener noreferrer"
