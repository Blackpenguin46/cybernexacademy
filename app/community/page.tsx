      ...
      <div className="container mx-auto px-4 mt-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-gray-300 mb-6">
            Connect with cybersecurity professionals, share knowledge, and stay updated on the latest security trends in our official Discord server.
          </p>
          <Link href="https://discord.gg/R8J3xMcRMD" target="_blank">
            <Button size="lg" className="bg-cyan-600 hover:bg-cyan-700">
              Join CyberNex Discord <ExternalLink className="w-4 h-4 ml-2" />
            </Button>
          </Link>
        </div>
      </div>
