    ...
    >
      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="px-4 lg:px-8 py-4 flex justify-center items-center relative">
          ...
          {/* Clean navbar layout with proper positioning */}
          <div className="hidden md:flex items-center w-full">
            ...
            <div className="flex-none ml-12">
              <Link 
                href="/" 
                className={`relative px-3 py-2 transition-all duration-300 flex items-center gap-2 group ${
                  isActive('/') 
                    ? 'text-neon-blue' 
              ...
              >
                ...
                <div className="relative">
                  <span className="block transition-opacity duration-200 group-hover:opacity-0">Home</span>
                  <span className="absolute left-0 top-0 opacity-0 transition-opacity duration-200 group-hover:opacity-100">127.0.0.1</span>
                </div>
              </Link>
            </div>
            ...
            <div className="flex-none mr-8 flex items-center gap-3">
            <div className="relative">
              <button 
                ...
                <Link
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-md ${
                    pathname === '/'
                      ...
                      : 'text-gray-300 border border-transparent hover:text-green-400 hover:border-green-400/30 hover:bg-green-400/5'
                  }`}
