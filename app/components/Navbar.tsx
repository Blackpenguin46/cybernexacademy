  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1920px] mx-auto">
        {/* Single navbar layout with all elements */}
        <div className="px-4 lg:px-8 py-4 flex items-center justify-between relative">
          ...
          <div className="flex items-center">
            <Link href="/" className="text-2xl font-bold text-white flex items-center gap-2 hover:opacity-80 transition-opacity" onClick={() => setActiveDropdown(null)}>
              <div className="bg-neon-blue/20 rounded-full p-1.5">
          ...
          {/* Center section with nav sections */}
          <div className="hidden md:flex items-center justify-center space-x-8 flex-1 max-w-md mx-auto">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {loading ? (
              ...
              <div className="flex items-center">
                <Link 
                  href="/auth/signup" 
                  className="flex items-center gap-2 text-white font-medium px-5 py-2.5 rounded-md transition-all duration-300 bg-gradient-to-r from-neon-blue/80 to-cyan-500/80 border-2 border-neon-blue/70 hover:border-neon-blue hover:from-neon-blue/90 hover:to-cyan-500/90 shadow-sm shadow-neon-blue/30"
                >
              ...
              <div className="px-4 py-6 space-y-6">
                ...
                <div className="pt-4 border-t border-neon-blue/30 space-y-3">
                  {loading ? (
                    ...
                    <Link 
                      href="/auth/signup" 
                      className="flex items-center justify-center gap-2 bg-gradient-to-r from-neon-blue/80 to-cyan-500/80 text-white font-medium px-4 py-3 rounded-md w-full border-2 border-neon-blue/50 hover:from-neon-blue/90 hover:to-cyan-500/90 shadow-sm shadow-neon-blue/30"
                      onClick={() => setMobileMenuOpen(false)}
                    >
