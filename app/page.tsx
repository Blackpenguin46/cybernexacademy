      ...
      <section className="py-20 bg-gray-950 border-t border-gray-800" aria-labelledby="quick-links-heading">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 id="quick-links-heading" className="text-3xl md:text-4xl font-bold mb-4 text-white">
              Quick Access
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[ 
              ...
              { href: "/insights/threat-intel", icon: AlertTriangle, title: "Threat Intelligence", description: "Latest threats & vectors.", color: "orange" },
