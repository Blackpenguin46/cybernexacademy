...
export default function NetworkingBasicsPage() {
  return (
    <div className="container mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-gray-100">Networking Basics</h1>
      <p className="text-gray-600 dark:text-gray-400 mb-8">
        This page will contain information about networking basics. Content coming soon!
      </p>
